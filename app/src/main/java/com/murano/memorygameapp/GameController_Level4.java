...
public class GameController_Level4 extends AppCompatActivity {
    private Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundOn = true;
        setContentView(layout.livel4);
        save_image = 0;
        max_click = 0;
        correct = 0;
        shuffle();
        clicked = new boolean[10];
        for (boolean it : clicked)
            it = false;

        click = 0;
        time = findViewById(id.timer_liv4);
        time.setBase(SystemClock.elapsedRealtime());
        time.start();
        text = (TextView) findViewById(id.mosse_field_liv4);
        back = (Button) findViewById(id.btn_back_liv4);
        sound = (Button) findViewById(id.btn_sound_liv4);
        animation_flip = AnimationUtils.loadAnimation(GameController_Level4.this, anim.flip);
        btn1 = (FrameLayout) findViewById(id.button1_l4);
        btn2 = (FrameLayout) findViewById(id.button2_l4);
        btn3 = (FrameLayout) findViewById(id.button3_l4);
        btn4 = (FrameLayout) findViewById(id.button4_l4);
        btn5 = (FrameLayout) findViewById(id.button5_l4);
        btn6 = (FrameLayout) findViewById(id.button6_l4);
        btn7 = (FrameLayout) findViewById(id.button7_l4);
        btn8 = (FrameLayout) findViewById(id.button8_l4);
        btn9 = (FrameLayout) findViewById(id.button9_l4);
        btn10 = (FrameLayout) findViewById(id.button10_l4);
    ...
    public void show(FrameLayout btn, int n) {
        ...
        Animation animation = AnimationUtils.loadAnimation(GameController_Level4.this, anim.flip);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if (max_click == 2) {
                ...
                if (save_image.equals(count_image.get(n)) && !selected_1.equals(btn)) { //<-- coppia trovata
                    ...
                    Animation anim1 = AnimationUtils.loadAnimation(GameController_Level4.this, anim.righttoleft);
                    ...
                    if(correct == 5){
                        ...
                        DatabaseHelper.save_point("Level_4",punteggio);
                    ...
                    Animation animation1 = AnimationUtils.loadAnimation(GameController_Level4.this, anim.shake);
                    Animation animation2 = AnimationUtils.loadAnimation(GameController_Level4.this, anim.shake);
    ...
    public void shuffle() {
        count_image  = new ArrayList<Integer>(Arrays.asList(mipmap.emoji1,mipmap.emoji1,mipmap.emoji2,mipmap.emoji2, mipmap.emoji3,mipmap.emoji3
                ,mipmap.emoji4,mipmap.emoji4,mipmap.emoji5,mipmap.emoji5));
